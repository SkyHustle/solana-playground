...
// define an address to also transfer lamports too, Phantom dev wallet
export const STATIC_PUBLICKEY = new PublicKey("EZdzQnCFeSD5TNkYf1f6qCCw4nudugvfbqVTWm8NPWuX");
